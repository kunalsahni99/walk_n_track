        ...
        builder: (_, constraints) =>
            ListView(
              padding: EdgeInsets.only(
                  top: constraints.maxHeight >= 660.0 ? 100.0 : 60.0),
              children: [
                Stack(
                  children: [
                    Align(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            ...
                            style: TextStyle(
                                color: Colors.white,
                                fontSize: constraints.maxHeight >= 660.0
                                    ? 22.0
                                    : 20.0,
                    ...
                    Positioned(
                      ...
                      child: Transform.rotate(
                          angle: 15 * (pi / 180),
                          child: Icon(
                              FontAwesomeIcons.walking, color: Colors.black87)
                      ),
                    ),
                    ...
                    Positioned(
                      ...
                      child: Transform(
                        ...
                        child: Transform.rotate(
                            angle: 15 * (pi / 180),
                            child: Icon(
                                FontAwesomeIcons.running, color: Colors.black87)
                        ),
                      ),
                    ),
                    ...
                    Positioned(
                      ...
                      child: Transform.rotate(
                          angle: 15 * (pi / 180),
                          child: Icon(FontAwesomeIcons.footballBall,
                  ...
                  children: [
                    ...
                    Container(
                      padding: EdgeInsets.symmetric(
                          horizontal: constraints.maxHeight >= 660.0
                              ? 30.0
                              : 20.0),
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: RaisedButton(
                              ...
                              onPressed: () {
                                loginUser(_phoneController.text.toString(), context);
                          ...
                          SizedBox(height: constraints.maxHeight >= 660.0
                              ? 30.0
                              : 10.0),
